...
\begin{itemize}
	...
	\item The lobby makes its decision $e$ as a function of $\tau^{ad} \ \left(\frac{\partial e}{\partial \tau^{ad}} \neq 0\right)$, and exogenous $\tau^a, \ga$, and $\pi \ \left(\frac{\partial e}{\partial \tau^a} \neq \frac{\partial e}{\partial \ga} \neq \frac{\partial e}{\partial \pi} \neq  0\right)$
		...
		\end{itemize}
	\item If the ITC sets $\tau^{ad}$ in a vacuum, then $\tau^{ad}$ is a function of exogenous $\tau^a, \ga$, and $\pi \ \left(\frac{\partial \tau^{ad}}{\partial \tau^a} \neq \frac{\partial \tau^{ad}}{\partial \ga} \neq \frac{\partial \tau^{ad}}{\partial \pi} \neq  0\right)$
		\begin{itemize}
			\item ITC cares that $\tau^{ad}$ has an impact on $e \ \left( \frac{\partial e}{\partial \tau^{ad}} \neq 0 \right)$
			\item ITC cares that $\tau^{ad}$ has an impact on $r \ \left( \frac{\partial r}{\partial \tau^{ad}} \neq 0, \text{ i.e. } \frac{\partial r}{\partial e}\frac{\partial e}{\partial \tau^{ad}} \neq 0\right)$
		\end{itemize}
	\item Now lobby chooses $e^{ad}$ to influence $\tau^{ad}$. Then $e^{ad}$ is a function of exogenous $\tau^a, \ga$, and $\pi \ \left(\frac{\partial e^{ad}}{\partial \tau^a} \neq \frac{\partial e^{ad}}{\partial \ga} \neq \frac{\partial e^{ad}}{\partial \pi} \neq  0\right)$
		\begin{itemize}
			\item UH OH! I forgot that $e^{ad}$ influences all sorts of things above. Have to fix!
			\item lobby cares that $e^{ad}$ has an impact on $\tau^{ad} \ \left( \frac{\partial \tau^{ad}}{\partial e^{ad}} \neq 0 \right)$
			\item lobby cares that $e^{ad}$ has an impact on $e \ \left( \frac{\partial e}{\partial \tau^{ad}} \frac{\partial \tau^{ad}}{\partial e^{ad}} \neq 0 \right)$
			\item lobby cares that $e^{ad}$ has an impact on $r \ \left( \frac{\partial r}{\partial e^{ad}} \neq 0, \text{ i.e. } \frac{\partial r}{\partial e}\frac{\partial e}{\partial \tau^{ad}} \frac{\partial \tau^{ad}}{\partial e^{ad}} \neq 0\right)$
		\end{itemize}
\end{itemize}
