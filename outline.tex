...
\vskip.3in
Main idea: extend SOP$\_$repeated model to endogenize length of dispute
\begin{itemize}
	\item Adapt SOP$\_$repeated (or SOP)
		\begin{itemize}
			\item Note: Chad wonders if repeated game / self-enforcement constraint is essential to story
		\end{itemize}
	\item When is it worth it for lobby to exert effort to prolong trade war?
	\item Chad and Maurizio Zanardi are working on a paper on AD 5-year reviews
		\begin{itemize}
			\item After five years, they come up for review 
				...
				\end{itemize}
			\item 40 percent of all WTO disputes have to do with AD, but of course not all AD measure go to dispute
