...
The effect on the renewal probability is determined by the sign of the derivative of the left hand side of the inequality in Expression~\ref{eq:b_ex} with respect to a positive shift in the $\pi(\cdot)$ function; to show that the renewal probability is increasing in such a positive shift, I must demonstrate that this derivative is negative. The derivative is 
\begin{equation}
