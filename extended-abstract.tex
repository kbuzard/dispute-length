...
Set up model
\begin{itemize}
	\item Take trade agreement tariff as given ($\tau^a_i$)
	\item Lobby exerts effort to convince ITC to apply anti-dumping duties (AD determined endogenously); there is a given amount of uncertainty for each $i$
